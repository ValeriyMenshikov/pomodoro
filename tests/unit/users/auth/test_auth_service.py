...
@pytest.mark.asyncio
async def test_get_google_redirect_url(mock_auth_service: AuthService, settings: Settings):
...
@pytest.mark.asyncio
async def test_generate_access_token(mock_auth_service: AuthService, settings: Settings):
    user_id = 1
